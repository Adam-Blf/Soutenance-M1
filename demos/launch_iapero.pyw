#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Lanceur demo · L'IA Pero (Streamlit Speakeasy, port 8502).
...
Fonctionne hors-ligne en fallback si GOOGLE_API_KEY absente."""
import os
import sys
import time
import shutil
...
PROJ = r"C:\Users\adamb\ia-pero"
APP = os.path.join(PROJ, "src", "app.py")
PORT = 8502
